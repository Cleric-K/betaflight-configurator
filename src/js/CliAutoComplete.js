...
CliAutoComplete.builderParseLine = function(line) {
    ...
    const isSentinel = line.indexOf(builder.sentinel) !== -1;
    var m;
    ...
    if (isSentinel) {
        ...
        if (command) {
            ...
            if (!this.configEnabled) {
                ...
                self.writeToOutput('Cancelled!<br># ');
                this.cleanup();
            }
            else {
                cache.settings.sort();
    ...
    $textarea.textcomplete([],
        {
            ...
            onKeydown: function(e) {
                ...
                // since this handler is triggered before replace()
                setTimeout(function() {
                    if (sendOnEnter && e.which == 13) {
